...
ActiveRecord::Schema.define(version: 20150129041242) do
  ...
  add_index "following_relationships", ["follower_id", "followed_user_id"], name: "unique index on followers", unique: true, using: :btree
